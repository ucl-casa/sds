...
Like Podman, Docker is 'just' another virtualisation tool that allows you to run virtual machines (VMs) on your computer's 'host' operating system. That's a lot of new, probably meaningless words. If you're one of those people who (understandably) likes to understand what's going on then here's how some people define it:

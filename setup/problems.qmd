...
1. And then run this command in PowerShell or Terminal to download the {{< var env.name >}} image with `podman pull {{< var docker.amd >}}` (or `{{< var docker.arm >}}` for M-chip Macs)

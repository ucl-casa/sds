...
If you *don't* see this window (or see lots of errors) then you may need to have a look at the '[dealing with problems](./problems.qmd)' page.
...
Whatever terminal (iTerm2, Terminal, Windows Terminal) you had open should now **be closed** and a new 'session' started. This is because the previously open Terminal(s) don't know anything about Podman and won't be able to find it to run the next set of commands. All *new* terminals from now on will know about `podman`.

...
It is *highly unlikely* that you have a 32-bit machine, so you would normally download the 64-bit version. It is also unlikely that you have an ARM device if you have an off-the-shelf Windows computer.

::: {.callout-important}
#### If you *have* a 32-bit machine

If it turns out that your machine *is* 32-bit, please let one of us know as we'll have to do some additional work to help you get the most out of the modules.
